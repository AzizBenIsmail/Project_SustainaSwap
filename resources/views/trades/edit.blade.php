            ...
            <div class="col-md-8 mt-3">
                ...
                <form method="POST" action="{{ route('trades.update', $trade->id) }}">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="date" name="proposalDate" class="form-control" value="{{ $trade->proposalDate }}" required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="status">Status :</label>
                        <input name="status" class="form-control" value="{{ $trade->status }}" required>
                    </div>
                    <div class="form-group mt-3">
