                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-12">
                                <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                    ...
                                    <p>Little Fashion templates comes with <a href="sign-in">sign in</a> / <a href="../auth/register.blade.php">sign up</a> pages, product listing / product detail, about, FAQs, and contact page.</p>
